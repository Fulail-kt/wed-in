import { N as NoImageMetadata, Q as AstroError, X as UnsupportedImageFormat, j as MissingSharp } from "./errors-data_B0SxhG_E.mjs";
import { v as detector } from "./path_DvYdieO7.mjs";
import { i as resolveDefaultOutputFormat, r as parseQuality, t as baseService } from "./service_DKnLkGQF.mjs";
//#region node_modules/.pnpm/astro@7.1.6_@emnapi+core@1._974862a4f6461bcc228954299e53a5ab/node_modules/astro/dist/assets/services/sharp.js
var sharp;
var qualityTable = {
	low: 25,
	mid: 50,
...
async function loadSharp() {
	let sharpImport;
	try {
		sharpImport = (await import("./dist_BQsS5KA6.mjs")).default;
	} catch {
