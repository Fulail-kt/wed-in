    ...
    <AnimatePresence>
      {!open && (
        ...
        >
          ...
          <div className="relative z-10 h-full flex flex-col items-center justify-center px-5 sm:px-6 text-center safe-pad pointer-events-none">
            <div className="w-full max-w-sm sm:max-w-md flex flex-col items-center">
              ...
              <div className="relative flex flex-col items-center select-none w-[min(100vw-2rem,22rem)] h-[15.5rem]">
                {/* One origin: nail + knot + rope + seal */}
                <div className="absolute left-1/2 top-0 w-0 h-0">
                  <div className="absolute left-1/2 -translate-x-1/2 -top-1 flex flex-col items-center z-30">
                    <div className="w-8 h-1.5 rounded-full bg-[#C2A166]/70 mb-1" />
                    <div ref={knotRef} className="w-2.5 h-2.5 rounded-full bg-[#C2A166]" />
                  </div>
